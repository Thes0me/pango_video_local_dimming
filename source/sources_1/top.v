...
//*******************************************************************************/
 ...
 module top(
//hdmi_in_convert_to_dvi_in
input           [7:0]                rgb_r, rgb_g, rgb_b,
input                                de_input, hs_input, vs_input,
input                                pclk_mod_in,
//*************************
input                                sys_clk,
input                                rst_n,
...
wire                            read_req_ack;
wire                            read_en;
wire[31:0]                      read_data/*synthesis syn_keep=1*/;
wire                            write_en;
wire[31:0]                      write_data/*synthesis syn_keep=1*/;
wire                            write_req;
wire                            write_req_ack;
...
assign write_data = {8'b0, rgb_r[7:0], rgb_g[7:0], rgb_b[7:0]};
...
(
	...
	.read_addr_1                (25'd2073600              ), //The second frame address is 25'd2073600(1080p),large enough address space for one frame of video
	.read_addr_2                (25'd4147200              ),
	.read_addr_3                (25'd6220800              ),
	.read_addr_index            (read_addr_index          ),
	.read_len                   (25'd460800               ), //frame size 1280 * 720 * 32 / 64 = 460800
	.read_en                    (read_en                  ),
	.read_data                  (read_data                ),
	...
	.write_addr_index           (write_addr_index         ),
	.write_len                  (25'd460800               ), //frame size 1280 * 720 * 32 / 64 = 460800
	.write_en                   (de_input                 ),
...
//�޸Ķ���ṹ
//add color bar to repalce cmos input
//wire de_input, hs_input, vs_input;
//wire [7:0] rgb_r, rgb_g, rgb_b;

//color_bar color_bar_input
//    (
//    .clk(video_clk),              // input
//    .rst(~rst_n),              // input
//    .hs(hs_input),                // output
//    .vs(vs_input),                // output
//    .de(de_input),                // output
//    .rgb_r(rgb_r),          // output[7:0]
//    .rgb_g(rgb_g),          // output[7:0]
//    .rgb_b(rgb_b)           // output[7:0]
//);
